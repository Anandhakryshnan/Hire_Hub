    ...
    const buttonsData = [
      {
        ...
        imgSrc:
          "https://cdn1.vectorstock.com/i/1000x1000/47/05/young-man-programmer-working-on-computer-with-code-vector-18324705.jpg",
        link: "/NewJobPosting",
      },
      {
        title: "Job Posted",
        imgSrc:
          "https://mir-s3-cdn-cf.behance.net/projects/404/8d92c7165061245.Y3JvcCwxNTAxLDExNzQsMCwxNTY.jpg",
        link: "/ViewJobPosting",
      },
      {
        title: "Interviews",
      ...
      },
      {
        title: "Chat",
        imgSrc:
          "https://static.vecteezy.com/system/resources/previews/014/002/235/non_2x/communication-logo-design-template-free-vector.jpg",
        link: "/chat",
      },
    ];
            ...
            <div className=" h-full overflow-y-auto grid place-items-center grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 pt-[8rem] pb-[4rem] ">
              {buttonsData.map((button, index) => (
                <AnimatedGradientBorderTW key={index}>
                  <Link
                    className=" cursor-pointer bg-[#7730fc58] rounded-lg no-underline"
                    to={button.link} 

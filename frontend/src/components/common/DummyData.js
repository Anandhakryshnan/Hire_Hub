...
export const buttonsData = [
  ...
  },
  {
    ...
    bgColor:
      "bg-[#BFEFFF] bg-opacity-50  border-2 border-blue-300 hover:shadow-[#BFEFFF]",
  ...
  },
  {
    ...
    bgColor:
      "bg-[#AFFFAF] bg-opacity-30 border-2 border-green-400 hover:shadow-[#AFFFAF]",
  ...
  },
  {
    ...
    bgColor:
      "bg-[#FFF09D] bg-opacity-50 border-2 border-yellow-400 hover:shadow-[#FFF09D]",
  ...
  //   bgColor:
  //     "bg-[#FFACD5] bg-opacity-30 border-2 border-pink-300 hover:shadow-[#FFACD5]",
  ...
  //   bgColor:
  //     "bg-[#EC9DFF] bg-opacity-30 border-2 border-violet-300 hover:shadow-[#EC9DFF]",
  ...
  //   bgColor:
  //     "bg-[#A3FFF6] bg-opacity-30 border-2 border-cyan-400 hover:shadow-[#A3FFF6]",
  ...
  //   bgColor:
  //     "bg-[#FFAFA0] bg-opacity-30 border-2 border-pink-300 hover:shadow-[#FFAFA0]",
  ...
  // },
  {
    ...
    bgColor:
      "bg-[#9F90FF] bg-opacity-30 border-2 border-indigo-300 hover:shadow-[#9F90FF]",
...
export const aboutUsCardContent = [
  {
    title: "Our Vision",
    details: `To be a premier technical institution imparting knowledge, to carve technically competent and research minded professionals with social responsibilities`,
  },
  {
    title: "Our MIssion",
    details: `Facilitate quality engineering education through state-of-the-art facilities and qualified vibrant teachers`,
  },
  {
    details: `Transform students to responsible professionals with ethical and social values capable of providing innovative solutions to the problems faced by the country and to enhance the quality of life of the people`,
  },
  {
    details: `Accomplish a conducive learning environment to equip students for higher education and life-long learning`,
  },
  {
    details: `Instill managerial skills and entrepreneurial capabilities`,
  },
];
...
export const coursesCard = [
  ...
  },
  {
    ...
    joinNowLink:
      "https://www.youtube.com/watch?v=fSmp7Cv-c_0&list=PLwGdqUZWnOp3t3qT7pvAznwUDzKbhEcCc&index=1&t=1s",
    courTeacher: [
      {
        dcover: avatar,
        name: "by Thapa Technical",
...
export const teamMember = [
  {
    ...
    socialLinks: {
      ...
      linkedin: "https://www.linkedin.com/in/anandhakryshnan/",
      portfolio: "https://anandhakryshnan.github.io/",
      mailto: "anandhakryshnan@gmail.com",
    },
  },
  {
    name: "Aiswarya M",
...
export const faq = [
  {
    ...
    answer:
      "Enrolling in online courses typically involves visiting the institution's website, creating an account, and following the provided instructions for course registration.",
  },
  {
    question:
      "Where can I find information about course fees and payment methods?",
    answer:
      "Information about course fees and payment methods is usually available on the institution's official website or can be obtained by contacting the admissions or finance department.",
  },
  {
    question:
      "How are online courses structured, and what is the learning format?",
    answer:
      "Online courses often include video lectures, readings, assignments, and interactive discussions. The specific format may vary, so it's essential to check the course details for more information.",
  },
  {
    question: "How can I access course materials and resources?",
    answer:
      "Course materials are typically accessible through a dedicated online platform or learning management system (LMS). Students receive login details upon enrollment.",
  },
  {
    question:
      "Are there any scholarships or financial aid options available for students?",
    answer:
      "Institutions often offer scholarships or financial aid programs. Details about eligibility criteria and application processes can be obtained from the financial aid office.",
  },
  {
    question:
      "What academic support services are available for online students?",
    answer:
      "Online students usually have access to academic support services, including online tutoring, discussion forums, and virtual office hours with instructors.",
  },
  {
    question: "How are assessments and exams conducted in online courses?",
    answer:
      "Assessments and exams in online courses may include quizzes, essays, and timed exams. The specific methods are outlined in the course syllabus.",
  },
  {
    question: "Can I transfer credits from previous academic programs?",
    answer:
      "Many institutions allow credit transfers, but the process and criteria vary. Students should contact the admissions or registrar's office for information on credit transfer policies.",
  },
  {
    question: "What technology requirements are needed for online courses?",
    answer:
      "Online courses may have specific technology requirements, such as a reliable internet connection, compatible devices, and software. These details are usually provided in the course answerription.",
  },
  {
    question:
      "How do I contact professors or instructors for academic assistance?",
    answer:
      "Contact information for professors or instructors is often available on the institution's website or the course syllabus. Students can use email or virtual office hours for communication.",
  },
];
    ...
    semesters: [
      ...
      },
      {
        ...
        courses: [
          ...
          },
          {
            ...
            job: "Power Electronics Engineer",
            difficulty: "high",
          },
          {
      ...
      },
      {
        ...
        courses: [
          { course: "VLSI Design", job: "VLSI Engineer", difficulty: "high" },
          {
            ...
            job: "Machine Design Engineer",
            difficulty: "medium",
          },
          {
            course: "Power System Protection",
            job: "Protection Engineer",
            difficulty: "high",
          },
        ],
      },
        ...
        courses: [
          {
            ...
            job: "High Voltage Engineer",
            difficulty: "high",
          },
          {
            course: "Digital Communication",
            job: "Digital Communication Engineer",
            difficulty: "medium",
          },
          {
        ...
        courses: [
          {
            ...
            job: "Optimization Engineer",
            difficulty: "medium",
          },
          {
            course: "Power System Analysis",
            job: "Power System Analyst",
            difficulty: "high",
          },
          {
      ...
      },
      {
        ...
        courses: [
          {
            course: "Smart Grids",
            job: "Smart Grid Engineer",
            difficulty: "high",
          },
          {
            course: "Artificial Intelligence in Power Systems",
            job: "AI Engineer",
            difficulty: "high",
          },
          {
    ...
    semesters: [
        ...
        courses: [
          {
            ...
            job: "Signal Processing Engineer",
            difficulty: "medium",
          },
          {
            course: "Microprocessors and Interfacing",
            job: "Embedded Systems Engineer",
            difficulty: "high",
          },
          {
            course: "Electronic Circuits",
            job: "Electronic Circuits Engineer",
            difficulty: "medium",
          },
        ],
      },
      ...
      },
      {
        ...
        courses: [
          ...
          },
          {
            ...
            job: "Optoelectronics Engineer",
            difficulty: "medium",
          },
          {
            course: "Digital Image Processing",
            job: "Image Processing Engineer",
            difficulty: "high",
          },
        ],
      },
      ...
      },
      {
        ...
        courses: [
          ...
          {
            course: "Antenna and Wave Propagation",
      ...
      },
      {
        ...
        courses: [
          ...
          {
            course: "VLSI Testing and Verification",
            job: "VLSI Testing Engineer",
            difficulty: "high",
          },
          {
            course: "Project Management",
    ...
    semesters: [
      ...
      },
      {
        ...
        courses: [
          ...
          {
            course: "Project Estimation and Costing",
            job: "Cost Engineer",
            difficulty: "medium",
          },
        ],
        ...
        courses: [
          {
            ...
            job: "Structural Dynamics Engineer",
            difficulty: "high",
          },
          {
        ...
        courses: [
          {
            ...
            job: "Advanced Manufacturing Engineer",
            difficulty: "medium",
          },
          {
        ...
        courses: [
          {
            ...
            job: "Vibration Analyst",
            difficulty: "high",
          },
          {
            course: "Composite Materials",
            job: "Composite Engineer",
            difficulty: "high",
          },
          {
  ...
  },
  {
    ...
    semesters: [
        ...
        courses: [
          {
            ...
            job: "Reaction Engineer",
            difficulty: "high",
          },
          {
            course: "Process Control",
            job: "Process Control Engineer",
            difficulty: "medium",
          },
          {
            course: "Chemical Engineering Thermodynamics",
            job: "Chemical Thermodynamics Engineer",
            difficulty: "high",
          },
        ],
      },
        ...
        courses: [
          {
            ...
            job: "Unit Operations Engineer",
            difficulty: "medium",
          },
          {
            course: "Separation Processes",
            job: "Separation Engineer",
            difficulty: "high",
          },
          {
            course: "Chemical Engineering Design",
            job: "Design Engineer",
            difficulty: "high",
          },
        ],
      },
      {
        ...
        courses: [
          {
            course: "Process Simulation",
            job: "Simulation Engineer",
            difficulty: "high",
          },
          {
            course: "Chemical Process Safety",
            job: "Process Safety Engineer",
            difficulty: "high",
          },
          {
            course: "Polymer Engineering",
            job: "Polymer Engineer",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        courses: [
          ...
          {
            course: "Petroleum Refining Engineering",
      ...
      },
      {
        ...
        courses: [
          ...
          {
            course: "Nanotechnology in Chemical Engineering",
            job: "Nanotechnology Engineer",
            difficulty: "medium",
          },
          {
            course: "Chemical Plant Design and Economics",
            job: "Plant Design Engineer",
            difficulty: "high",
          },
        ],
      },
        ...
        courses: [
          {
            ...
            job: "Industrial Intern",
            difficulty: "medium",
          },
          {
            course: "Seminar and Project",
            job: "Project Engineer",
            difficulty: "high",
          },
          {
            course: "Advanced Topics in Chemical Engineering",
            job: "Advanced Engineer",
            difficulty: "high",
          },
        ],
      },
    ...
    semesters: [
      {
        ...
        courses: [
          ...
          },
          {
            ...
            job: "Environmental Chemist",
            difficulty: "high",
          },
          {
            course: "Water and Wastewater Treatment",
      ...
      },
      {
        ...
        courses: [
          {
            course: "Air Pollution Control Engineering",
            job: "Air Pollution Control Engineer",
            difficulty: "high",
          },
          {
            course: "Solid Waste Management",
            job: "Waste Management Engineer",
            difficulty: "medium",
          },
          {
            course: "Environmental Microbiology",
            job: "Environmental Microbiologist",
            difficulty: "high",
          },
        ],
      },
      {
        ...
        courses: [
          {
            course: "Hydrology and Watershed Management",
            job: "Hydrologist",
            difficulty: "medium",
          },
          {
            course: "Soil and Groundwater Remediation",
            job: "Remediation Engineer",
            difficulty: "high",
          },
          {
            course: "Environmental Impact Assessment",
            job: "Environmental Assessor",
            difficulty: "high",
          },
        ],
      },
      {
        ...
        courses: [
          ...
          },
          {
            ...
            job: "Environmental Policy Analyst",
            difficulty: "high",
          },
          {
            course: "Sustainability and Green Design",
            job: "Sustainability Engineer",
            difficulty: "medium",
          },
        ],
      },
      ...
      },
      {
        ...
        courses: [
          {
            course: "Environmental Modeling",
            job: "Environmental Modeler",
            difficulty: "high",
          },
          {
            course: "Risk Assessment and Management",
            job: "Risk Assessment Engineer",
            difficulty: "high",
          },
          {
            course: "Environmental Economics",
            job: "Environmental Economist",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        courses: [
          {
            course: "Advanced Water Treatment Technologies",
            job: "Advanced Water Treatment Engineer",
            difficulty: "high",
          },
          {
            course: "Environmental Monitoring and Analysis",
            job: "Environmental Analyst",
            difficulty: "medium",
          },
          {
            course: "Green Building Design",
            job: "Green Building Engineer",
            difficulty: "medium",
          },
        ],
      },
      {
        ...
        courses: [
          {
            course: "Internship in Environmental Engineering",
            job: "Environmental Engineering Intern",
            difficulty: "medium",
          },
          {
            course: "Capstone Project",
            job: "Environmental Engineering Project Manager",
            difficulty: "high",
          },
          {
            course: "Advanced Topics in Environmental Engineering",
            job: "Advanced Environmental Engineer",
            difficulty: "high",
          },
        ],
      },

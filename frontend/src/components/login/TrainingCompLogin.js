...
const TrainingCompLogin  = () => {
    ...
    const handleRedirection = () => {
        navigate(`/TreningRegister`)
    };

    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://localhost:9000/api/trainingCompanyLogin', {
                method: 'POST',
                headers: {
...
export default TrainingCompLogin;

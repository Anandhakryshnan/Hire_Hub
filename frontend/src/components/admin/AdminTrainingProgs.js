        ...
        >
          <Table>
            <TableHead>
              ...
              >
                {["Program Name", "Description", "Actions"].map((cell, indx) => (
                  <TableCell
                    sx={{
                      fontSize: "18px",
                      fontWeight: "bold",
                    ...
                    key={indx}
                  >
                    <span className="text-green-800">{cell}</span>
                  </TableCell>
                ))}
              </TableRow>
            </TableHead>
        ...
        >
          <Table>
            <TableHead>
              ...
              >
                {["Program Name", "Description", "QR Code", "Attendance"].map((cell, indx) => (
                  <TableCell
                    sx={{
                      fontSize: "18px",
                      fontWeight: "bold",
            ...
            <TableBody sx={{ color: "black" }}>
              {approvedPrograms.length > 0 ? (
                ...
                <TableRow>
                  <TableCell colSpan="4" className="text-center py-4 text-gray-500 font-medium">
...
// NavBar and other components remain the same as in the AdminCompany component
const tabs = [

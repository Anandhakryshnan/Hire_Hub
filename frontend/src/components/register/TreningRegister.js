    ...
    <BgColorAnimation
      child={
        <Form
          ...
          className={` h-screen overflow-auto flex items-center justify-center px-2`}
        >
          <div
            className={`container bg-[#ffffff30] shadow-md rounded h-[97vh] md:h-auto overflow-y-auto py-3 lg:px-4`}
          >
            ...
            <Row className="mb-[.9rem] space-y-[.9rem] md:space-y-0">
              ...
              <Form.Group
                ...
                xs={12}
                md={6}
                controlId="formGridCompanywebsite"
                className="position-relative"
              >
                <input
                  type="text"
                  ...
                  className={`border-y-2 pt-2.5 pb-2 px-2 focus:border-b-2 transition-colors focus:outline-none bg-slate-800 h-full font-robotoMono placeholder:text-blue-300 text-green-300 ${
                    companyWebsite ? "border-indigo-400" : ""
                  } focus:border-indigo-400 w-full`}
            ...
            <Row className="mb-[.9rem] space-y-[.9rem] md:space-y-0">
              <Form.Group as={Col} xs={12} md={6} controlId="formGridEmail">
                <input
                  ...
                  className={`border-y-2 pt-2.5 pb-2 px-2 focus:border-b-2 transition-colors focus:outline-none bg-slate-800 w-full h-full font-robotoMono placeholder:text-blue-300 text-green-300 ${
              ...
              >
                <input
                  ...
                  className={`border-y-2  py-2 pl-2 pr-8 focus:border-b-2 transition-colors focus:outline-none bg-slate-800 w-full h-full font-robotoMono placeholder:text-blue-300 text-green-300 ${
            ...
            <Row className="mb-[.9rem] space-y-[.9rem] md:space-y-0">
              ...
              >
                <input
                  ...
                  className={`border-y-2  pt-2.5 pb-2 px-2 focus:border-b-2 transition-colors focus:outline-none bg-slate-800 w-full h-full font-robotoMono placeholder:text-blue-300 text-green-300 ${
                    contactNumber ? "border-indigo-400" : ""
                  } focus:border-indigo-400`}
            ...
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formGridAddress">
                <textarea
                  ...
                  required
                  className={`border-y-2 pt-2.5 pb-2 px-2 focus:border-b-2 transition-colors focus:outline-none bg-slate-800 h-full font-robotoMono placeholder:text-blue-300 text-green-300 ${
                    companyDescription ? "border-indigo-400" : ""
                  } focus:border-indigo-400 w-full`}
...
export default TreningRegister;
